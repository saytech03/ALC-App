...
function Event3() {
    ...
    const VIDEO_URL = "https://youtu.be/tv3yTrf2kzw?si=lOGH88wRTKj01wf0";
        ...
        <div className="relative min-h-screen bg-black">
            ...
            <div className="absolute inset-0 bg-gradient-to-br from-gray-400 to-blue-400 z-0">
                <div
                    ...
                    style={{ backgroundImage: `url('./shrine.jpg')` }}
                />
            </div>
            ...
            <div className="relative z-10 pt-24 pb-16 px-4 max-w-4xl mx-auto">
                ...
                <div className="prose prose-lg max-w-none text-gray-700 leading-relaxed space-y-6">
                    ...
                    <div className="mt-12">
                        <YouTubePreview videoUrl={VIDEO_URL} />
                    </div>
...
function YouTubePreview({ videoUrl }) {
    const videoRef = useRef(null);
    const [playing, setPlaying] = useState(false);

    const videoIdMatch = videoUrl.match(/(?:youtu\.be\/|youtube\.com\/(?:watch\?v=|embed\/))([A-Za-z0-9_-]{11})/);
    const embedUrl = videoIdMatch ? `https://www.youtube.com/embed/${videoIdMatch[1]}?rel=0` : null;
    const thumbnailUrl = videoIdMatch ? `https://img.youtube.com/vi/${videoIdMatch[1]}/hqdefault.jpg` : null;
        ...
        <div className="relative w-full max-w-4xl mx-auto">
            {embedUrl ? (
                    ...
                    {!playing ? (
                        ...
                        >
                            ...
                            <div className="absolute inset-0 flex items-center justify-center bg-black/30">
                                <div className="flex h-16 w-16 items-center justify-center rounded-full bg-white/90 text-black text-3xl shadow-lg transition">
                                    ▶
                                </div>
                            </div>
                        </button>
                    ) : (
                        <div className="relative block w-full aspect-video">
                            <iframe
                                ref={videoRef}
                                width="100%"
                                height="100%"
                ...
                <div className="rounded-3xl border border-white/20 bg-slate-900/90 p-6 text-white">
                    ...
                    <p className="mt-2 text-sm text-slate-300">Add the YouTube URL in the code to enable playback.</p>
                </div>
            )}
        </div>
    );
